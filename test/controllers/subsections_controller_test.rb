...
class SubsectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subsection" do
    assert_difference('Subsection.count') do
      post subsections_url, params: { subsection: { description: @subsection.description, link: @subsection.link, name: @subsection.name, position: @subsection.position, shortname: @subsection.shortname, status: @subsection.status } }
    end
  ...
  test "should update subsection" do
    patch subsection_url(@subsection), params: { subsection: { description: @subsection.description, link: @subsection.link, name: @subsection.name, position: @subsection.position, shortname: @subsection.shortname, status: @subsection.status } }
